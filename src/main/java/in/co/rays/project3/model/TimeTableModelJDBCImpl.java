...
public class TimeTableModelJDBCImpl {
	...
	public int add(TimeTableDTO bean) throws ApplicationException, DuplicateRecordException {
...
//				bean.setModified_Date_Time(rs.getTimestamp(12));
	 ...
	 * @throws ApplicationException the application exception
	 */
	public TimeTableDTO findByPk(int pk) throws ApplicationException {
...
//				bean.setModified_Date_Time(rs.getTimestamp(12));
     ...
     * @throws ApplicationException the application exception
     */
    public   TimeTableDTO checkBycss(int CourseId , int SubjectId , String i) throws ApplicationException
    {
...
//				bean.setModified_Date_Time(rs.getTimestamp(12));
         ...
         * @throws ApplicationException the application exception
         */
        public  TimeTableDTO checkBycds(int CourseId, String i ,Date ExamDate) throws ApplicationException
    {
...
//				bean.setModified_Date_Time(rs.getTimestamp(12));
    ...
    * @return the time table bean
    */
   public static TimeTableDTO checkBysemester(int CourseId,int SubjectId,String semester,java.util.Date ExamDAte)
    {
...
//				bean.setModified_Date_Time(rs.getTimestamp(12));
     ...
     * @return the time table bean
     */
    public static TimeTableDTO checkByCourseName(int CourseId,java.util.Date ExamDate)
    {
    	Connection conn = null;
    	TimeTableDTO bean=null;
