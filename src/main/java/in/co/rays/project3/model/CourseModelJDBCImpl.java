...
public class CourseModelJDBCImpl {
	...
	public int add(CourseDTO bean) throws ApplicationException, DuplicateRecordException {
		//log.debug("CourseModel Add method END");
		Connection conn = null;
		int pk = 0;
		
//		CourseDTO duplicateCourseName = findByName(bean.getCourse_Name());
...
//		}
	...
	public CourseDTO findByPk(int pk) throws ApplicationException {
