...
import in.co.rays.project3.util.JDBCDataSource;
	...
	public class SubjectModelJDBCImpl {
	 ...
	 public int add(SubjectDTO bean) throws ApplicationException,
	            DuplicateRecordException, SQLException {
...
//	            pstmt.setTimestamp(8, bean.getCreatedBy());
...
//	     pstmt.setInt(9, bean.getId());
	...
	// log.debug("Model update End");
		...
		public SubjectDTO findByName(String i) throws ApplicationException {
