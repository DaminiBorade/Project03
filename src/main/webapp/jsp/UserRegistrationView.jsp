...
<%-- 										value="<%=((id==0)?DataUtility.getStringData(dto.getPassword()):DataUtility.getStringData(dto.getPassword()))%>" --%>
<!-- 										class="form-control border" style="height: 19px ; background-color:white" -->
                          ...
                          map.put("", "-------Select----------");
                           ...
                           %>
							...
							<div class="md-form">
								...
								<font color="red" class="ml-5" style="height: 19px ; background-color:" placeholder="Enter Gender"> <%=ServletUtility.getErrorMessage("gender", request) %></font>
							</div>
							...
							<div class="md-form">
								<div class="input-group mb-3">
									...
									<input type="text" id="datepicker" readonly="readonly"name="dob"
