...
&emsp;&emsp;&emsp;
	...
	<strong style="color: white">State Name :~</strong>&nbsp;
    <div class="col-sm-2">		 
    <input placeholder="Enter City Name" style="background-color: white"  type="text"   name="State" class="border"  value="<%=ServletUtility.getParameter("State", request)%>"> 
